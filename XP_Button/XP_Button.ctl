VERSION 5.00
Begin VB.UserControl Button_XP 
   ClientHeight    =   480
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   990
   ...
   ScaleWidth      =   66
   Tag             =   "030102-15"
   ToolboxBitmap   =   "XP_Button.ctx":0000
...
'********************************************************************
'Written by Mohammad AlianNejadi
'Copyright (C) 2003-2004
'website: www.geocities.com/m_alian14/
'e-mail: m_alian2003@hotmail.com
'Please vote this application in www.planetsourcecode.com
'********************************************************************
